<template>
  ...
  >
    <h1
      class="text-3xl font-semibold text-slate-500 flex items-center justify-center py-10 my-10 border rounded-lg shadow-2xl"
    >
      Tracksheet & Strategies
    </h1>
        ...
        <h1
          ...
          :style="
            currentCategoryIndex === catIndex
              ...
              : ''
          "
          class="rounded-3xl shadow-xl border-2 border-gray-400 text-white font-bold text-3xl p-10 flex flex-wrap relative items-center justify-center"
        >
          {{ cat.name }}
          <div
            v-if="currentCategoryIndex === catIndex"
    ...
    <div class="rounded-lg shadow-2xl border-2 mt-5 p-10 relative">
      ...
      <div class="flex flex-wrap gap-5">
        <div
          v-for="(track, trackIndex) in displayedTracks"
          :key="trackIndex"
          class="flex justify-between border border-cyan-600 rounded-xl p-2 w-72 hover:text-purple-600 cursor-pointer"
        >
